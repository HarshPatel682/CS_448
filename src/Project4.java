...
public class Project4
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Handout Test Case:\n\t" + Arrays.toString(CC_Patel682.executeSchedule(newDB(),tc1)) + "\n");
		System.out.println("Three Transactions Test Case:\n\t" + Arrays.toString(CC_Patel682.executeSchedule(newDB(),tc2)) + "\n");
		System.out.println("Deadlocks Test Case:\n\t" + Arrays.toString(CC_Patel682.executeSchedule(newDB(),tc3)) + "\n");
		System.out.println("No Conflicts Test Case:\n\t" + Arrays.toString(CC_Patel682.executeSchedule(newDB(),tc4)) + "\n");
		System.out.println("Multiple Deadlocks Test Case:\n\t" + Arrays.toString(CC_Patel682.executeSchedule(newDB(),tc5)) + "\n");
		System.out.println("Larger Deadlock Cycle Test Case:\n\t" + Arrays.toString(CC_Patel682.executeSchedule(newDB(),tc6)) + "\n");
	}
}